...
export async function generateMetadata({
  ...
  const domainDescription =
    domain?.description || 'Explore engineering projects, research, and resources.';

  return {
    title: `${domainName} - Axiora`,
    description: `${domainDescription} Discover featured projects, research papers, datasets, and contributors in this domain.`,
    keywords: [domainName, 'engineering', 'projects', 'research', 'datasets', 'Axiora'],
    openGraph: {
      title: `${domainName} - Axiora`,
