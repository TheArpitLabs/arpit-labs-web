          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-muted leading-relaxed max-w-xl">
                Axiora Innovation Hub is a launchpad for disruptive startups and radical engineering
                projects. We provide the mentorship, validation, and infrastructure to scale your
                vision.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4 pt-12">
                <div className="rounded-3xl border border-border/70 bg-card p-6 shadow-sm">
                  ...
                  <p className="text-xs text-muted">
                    Rapid prototyping and market testing for your core product.
                  </p>
                </div>
                <div className="rounded-3xl border border-border/70 bg-card p-6 shadow-sm">
                  ...
                  <p className="text-xs text-muted">
                    Connect with industry experts in AI, IoT, and Cybersecurity.
                  </p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="rounded-3xl border border-border/70 bg-card p-6 shadow-sm">
                  ...
                  <p className="text-xs text-muted">
                    Direct pipelines to Axiora&apos; global partner network.
                  </p>
                </div>
                <div className="rounded-3xl border border-border/70 bg-card p-6 shadow-sm">
                  ...
                  <p className="text-xs text-muted">
                    Pre-configured infrastructure and edge computing resources.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted max-w-2xl mx-auto">
              Discover the next generation of technology companies being built at Axiora.
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {startups.map((startup) => (
              <div
                key={startup.id}
                className="group relative flex flex-col rounded-[2.5rem] border border-border/70 bg-card p-8 transition hover:border-primary"
              >
            ...
            <div className="flex flex-col justify-center rounded-[2.5rem] border-2 border-dashed border-border/70 p-8 text-center transition hover:border-primary/50">
              ...
              <p className="mt-2 text-sm text-muted">
                Join the ecosystem and build the future with us.
              </p>
