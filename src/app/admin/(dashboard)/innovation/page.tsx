...
export default async function AdminInnovationPage({ searchParams }: AdminInnovationPageProps) {
  ...
  const editingStartup = params?.edit 
    ? startups.find((s) => s.id === params.edit) 
    : null;
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        <div className="w-full lg:w-2/5">
          <AdminSection 
            ...
            description="Add a new startup to the Arpit Labs ecosystem."
          >
        ...
        <div className="w-full lg:w-3/5">
          <AdminSection title="Startup Portfolio" description="Startups currently in the incubator.">
            {startups.length > 0 ? (
              ...
              <AdminEmptyState title="No startups" description="Start incubating your first startup idea." />
            )}
          </AdminSection>
        </div>
      </div>
