        ...
        <Container className="relative">
          <div className="mx-auto max-w-3xl text-center space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-1.5 text-sm font-bold tracking-wide text-primary">
              <GraduationCap size={18} /> Axiora University
            </div>
            <h1 className="text-5xl font-extrabold tracking-tight text-foreground sm:text-6xl">
              Professional Certifications for the Future.
            </h1>
            <p className="text-xl text-muted leading-relaxed">
              Accelerate your career with industry-recognized credentials in AI, IoT, and
              Cybersecurity. Built for engineers, by engineers.
            </p>
          ...
          <section className="space-y-12">
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <p className="text-muted">
                  Master specific technology domains and earn your certificate.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {certifications.map((cert) => (
                <div
                  key={cert.id}
                  className="group relative flex flex-col rounded-[2.5rem] border border-border/70 bg-card p-2 transition hover:border-primary/50 hover:shadow-2xl dark:bg-slate-950/50"
                >
          ...
          <section className="mt-12 grid gap-8 rounded-[3rem] border border-primary/20 bg-primary/5 p-12 lg:grid-cols-2 lg:items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted">
                Our certifications are recognized by leading technology companies and research
                institutions globally. We ensure every badge holder meets the highest standards of
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted">
                      Hands-on assessment for every certification.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
