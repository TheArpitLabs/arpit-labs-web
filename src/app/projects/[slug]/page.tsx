              ...
              <Card className="p-8">
                ...
                {project.lessons_learned && project.lessons_learned.length > 0 ? (
                  ...
                  <p className="mt-4 text-lg leading-relaxed text-muted">
                    The core lesson from this build is the value of iterating on architecture early,
                    documenting tradeoffs clearly, and keeping the implementation modular enough to
                  ...
                  <div className="mt-6 space-y-3">
                    ...
                    {project.verification_date && (
                      <div className="flex items-center gap-2 text-sm text-muted">
                        ...
                        <span>
                          Verified on {new Date(project.verification_date).toLocaleDateString()}
                        </span>
                      </div>
                    )}
                  </div>
                ...
                {project.screenshots && project.screenshots.length > 0 ? (
                  <div className="mt-6 grid gap-4">
                    {project.screenshots?.map((image: string, index: number) => (
                      <div
                        key={image}
                        className="relative overflow-hidden rounded-[1.5rem] border border-border/70 glass aspect-[16/9]"
                      >
                        <Image
                          src={image}
                  ...
                  <p className="mt-4 text-muted">
                    Visual documentation will appear here as more screenshots are published for this
                    project.
                  </p>
                )}
              </Card>
                      ...
                      <div key={index} className="flex gap-4">
                        ...
                        <div className="flex-1 pb-6">
                          <div className="flex items-center gap-2 text-sm text-muted">
                            <Calendar size={14} />
                            <span>
                              {milestone.date || new Date(project.created_at).toLocaleDateString()}
                            </span>
                          </div>
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 pb-6">
                        ...
                        <p className="mt-1 text-sm text-muted">
                          Building the main features and functionality
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-4">
                ...
                {project.contributors && project.contributors.length > 0 ? (
                  <div className="mt-6 space-y-3">
                    {project.contributors?.map((contributor: any, index: number) => (
                      <div
                        key={index}
                        className="flex items-center gap-3 rounded-xl border border-border/70 p-3 transition hover:border-primary hover:bg-primary/5"
                      >
                ...
                <Card className="p-8">
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-3 text-sm text-muted">
                      This is a verified open-source project showcased for educational purposes. All
                      credit goes to the original maintainers.
                    </p>
                  </div>
                </Card>
              )}
        ...
        <AnimatedSection>
          <div className="rounded-[2.5rem] glass p-10 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-muted">
              I&apos;m always happy to talk through system design decisions, architecture tradeoffs,
              and engineering lessons from projects like this one.
            </p>
