...
export const metadata = {
  title: 'Products | Axiora',
  description:
    'Discover AI and automation products built by Axiora for modern engineering workflows.',
};
    ...
    <main className="min-h-screen bg-background text-foreground">
        ...
        <Container>
          <div className="mx-auto max-w-4xl space-y-6 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted">
              AI-first solutions built for practical automation, intelligent workflows, and
              next-generational system design.
            </p>
          </div>
        </Container>
      </section>
      ...
      <Container>
        <section className="py-20">
          {products.length === 0 ? (
            <div className="rounded-[2rem] border border-border/70 bg-card/90 p-12 text-center text-muted">
                ...
                >
                  ...
                  <div className="space-y-4 p-8">
                    <div className="flex flex-wrap items-center gap-3">
                      <Badge
                        variant="outline"
                        className="px-3 py-1 text-xs uppercase tracking-[0.24em] text-muted"
                      >
                        {product.category}
                      </Badge>
