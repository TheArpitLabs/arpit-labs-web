        ...
        <Container className="relative z-10">
          <div className="max-w-3xl space-y-6">
            ...
            <p className="text-xl text-muted">
              Join engineers, researchers, and creators in building the future of AI and IoT.
            ...
            <section>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {chapters.map((chapter) => (
                  <div
                    key={chapter.id}
                    className="group rounded-3xl border border-border bg-surface p-6 transition hover:border-primary"
                  >
                    ...
                    <p className="text-sm text-muted">
                      ...
                      {chapter.country_name || chapter.country}
                    </p>
          ...
          <aside className="space-y-8">
            ...
            <div className="rounded-3xl border border-border bg-primary/5 p-6">
              ...
              <p className="mb-4 text-sm text-muted">
                Real-time collaboration with the global team.
              </p>
