...
export const knowledgeFeatureFlags = {
  ...
  contributorIntelligence: envEnabled("NEXT_PUBLIC_FEATURE_CONTRIBUTOR_INTELLIGENCE", true),
  autonomousDiscovery: envEnabled("NEXT_PUBLIC_FEATURE_AUTONOMOUS_DISCOVERY", true),
  researchIntelligence: envEnabled("NEXT_PUBLIC_FEATURE_RESEARCH_INTELLIGENCE", true),
  datasetIntelligence: envEnabled("NEXT_PUBLIC_FEATURE_DATASET_INTELLIGENCE", true),
