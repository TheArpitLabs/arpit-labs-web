...
class GitHubCircuitBreaker {
  ...
  private openCircuit(): void {
    ...
    console.error('[CIRCUIT BREAKER] Circuit opened due to consecutive failures');
  ...
  private closeCircuit(): void {
    ...
    console.log('[CIRCUIT BREAKER] Circuit closed - requests are allowed');
  ...
  private halfOpenCircuit(): void {
    ...
    console.log('[CIRCUIT BREAKER] Circuit half-open - testing with limited requests');
