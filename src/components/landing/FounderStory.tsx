...
const journeyMilestones = [
  {
    ...
    description:
      'Began exploration of embedded systems and IoT protocols while building hardware prototypes',
    icon: Lightbulb,
  },
  {
    year: '2022',
    ...
    description:
      'Expanded into full-stack development and AI/ML research, publishing initial open-source projects',
    icon: Code2,
  },
  {
    year: '2024',
    ...
    description:
      'Founded Axiora as a unified platform for hardware, software, and AI engineering projects',
    icon: Rocket,
  },
  {
    year: '2026',
    title: 'Ecosystem Growth',
    description: 'Building comprehensive engineering resources and community for hands-on learning',
    icon: Target,
  },
];
...
const coreValues = [
  {
    ...
    description: 'Pushing boundaries in AI, IoT, and emerging technologies',
    icon: Lightbulb,
  },
  {
    title: 'Quality Engineering',
    description: 'Building production-ready systems with best practices',
    icon: Code2,
  },
  {
    title: 'Knowledge Sharing',
    description: 'Open-source philosophy with comprehensive documentation',
    icon: Shield,
  },
  {
    title: 'Community Driven',
    description: 'Collaborative approach to engineering challenges',
    icon: Cpu,
  },
];
    ...
    <section className="py-12">
      ...
      >
        ...
        <p className="mx-auto max-w-3xl text-base text-muted">
          From hardware prototypes to AI-powered systems, follow Arpit Kumar&apos;s journey in
          creating a platform that bridges the gap between academic learning and industry-ready
          engineering.
        </p>
      </motion.div>
      ...
      <div className="mb-20 grid gap-8 lg:grid-cols-2">
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-lg text-muted leading-relaxed">
              To democratize access to industry-grade engineering education by providing real-world
              projects, comprehensive documentation, and AI-powered learning tools that bridge the
              gap between academic knowledge and professional excellence.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-lg text-muted leading-relaxed">
              To build the most comprehensive engineering platform that empowers students,
              researchers, and professionals to master AI, IoT, software, and hardware through
              hands-on experience with production-quality projects and cutting-edge tools.
            </p>
          </div>
        </motion.div>
      </div>
      ...
      >
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-muted">Key milestones that shaped Axiora</p>
        </div>
                  ...
                  >
                    <div className="relative overflow-hidden rounded-2xl glass p-6">
                      ...
                      <div className="relative">
                        ...
                        <h4 className="mb-2 text-xl font-heading font-bold text-foreground">
                          {milestone.title}
                        </h4>
          ...
          {coreValues.map((value, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <h4 className="mb-2 text-lg font-heading font-bold text-foreground">
                  {value.title}
                </h4>
        ...
        <div className="relative overflow-hidden rounded-3xl glass p-12 text-center">
          ...
          <div className="relative">
            ...
            <p className="mb-8 max-w-2xl mx-auto text-lg text-muted">
              Be part of the next generation of engineering excellence. Explore projects, contribute
              to research, and build the future with Axiora.
            </p>
