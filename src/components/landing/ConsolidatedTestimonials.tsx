...
const testimonials = [
  {
    ...
    content:
      "Axiora's AI explanations helped me understand machine learning completely. The learning path was incredible and practical. I've recommended this platform to my entire team.",
    rating: 5,
    avatar: 'SC',
  },
  {
    ...
    content:
      'Started contributing during college, now building real systems! The project documentation and community support are unmatched. Best decision for my engineering career.',
    rating: 5,
    avatar: 'RS',
  },
  {
    ...
    content:
      'Found my dream job through Axiora projects! The hands-on experience with IoT systems made all the difference in interviews. Real-world projects matter.',
    rating: 5,
    avatar: 'AR',
  },
  {
    ...
    content:
      'Axiora transformed my understanding of AI. The projects are industry-grade and the documentation is exceptional. My professors were impressed by my portfolio.',
    rating: 5,
    avatar: 'PS',
  },
  {
    ...
    content:
      "The research resources and collaboration opportunities have accelerated our lab's work significantly. High-quality publications and excellent datasets.",
    rating: 5,
    avatar: 'RK',
  },
  {
    ...
    content:
      'Even as an experienced engineer, I found the advanced projects incredibly valuable for staying current with modern engineering practices.',
    rating: 5,
    avatar: 'AC',
  },
];
    ...
    <section className="py-24">
      ...
      >
        ...
        <p className="mx-auto max-w-3xl text-lg text-muted">
          Hear from engineers, researchers, and students who have transformed their careers with
          Axiora.
        </p>
      </motion.div>
