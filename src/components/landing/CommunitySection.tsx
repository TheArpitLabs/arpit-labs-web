...
const communityTypes = [
  {
    title: 'Students',
    description:
      'Undergraduate and graduate students building their engineering portfolios through hands-on projects',
    icon: GraduationCap,
  ...
  },
  {
    title: 'Researchers',
    description:
      'Academic researchers and PhD candidates exploring cutting-edge AI, IoT, and cybersecurity',
    icon: Microscope,
  ...
  },
  {
    title: 'Developers',
    description:
      'Professional developers and engineers enhancing their skills with advanced projects',
    icon: Code2,
  ...
  },
  {
    title: 'Startups',
    description:
      'Early-stage startups leveraging Axiora resources for rapid prototyping and development',
    icon: Rocket,
...
const testimonials = [
  {
    ...
    content:
      'Axiora transformed my understanding of AI. The projects are industry-grade and the documentation is exceptional.',
    avatar: 'PS',
  },
  {
    ...
    content:
      "The research resources and collaboration opportunities have accelerated our lab's work significantly.",
    avatar: 'RK',
  },
  {
    name: 'Alex Chen',
    ...
    content:
      'Even as an experienced engineer, I found the advanced projects incredibly valuable for staying current.',
    avatar: 'AC',
  },
];
    ...
    <section className="py-12">
      ...
      >
        ...
        <p className="mx-auto max-w-3xl text-base text-muted">
          Connect with students, researchers, developers, and innovators from around the world who
          ...
          {communityTypes.map((type, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="mb-6 text-base text-muted leading-relaxed">{type.description}</p>
      ...
      {/* <motion.div
        ...
        >
          <div className="mb-12 text-center">
            ...
            <p className="mt-4 text-muted">What our members say about Axiora</p>
          </div>
        ...
        <div className="relative overflow-hidden rounded-3xl glass p-12 text-center">
          ...
          <div className="relative">
            ...
            <p className="mb-8 max-w-2xl mx-auto text-lg text-muted">
              Become part of a thriving community of engineers, researchers, and innovators building
              the future together.
            </p>
