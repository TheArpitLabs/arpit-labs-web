  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        <Link
          href="/"
          className="group inline-flex items-center gap-3 text-lg font-heading font-semibold text-foreground transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70"
        >
        ...
        <div className="flex items-center gap-3">
              ...
              {langOpen && (
                ...
                >
                  <button
                    ...
                    className="w-full rounded-lg px-4 py-2 text-left text-xs font-medium text-foreground transition-colors hover:bg-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70"
                    role="menuitem"
                  >
                    English
                  </button>
          ...
          {user ? (
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/login"
                className="hidden cursor-pointer rounded-xl border border-border bg-surface px-3 py-1.5 text-sm font-bold text-foreground transition hover:bg-surface-elevated sm:block"
              >
                Login
              </Link>
              <Link
                href="/register"
                className="cursor-pointer rounded-xl bg-gradient-to-r from-primary to-accent px-3 py-1.5 text-sm font-bold text-white shadow-glow transition hover:opacity-90"
              >
                Get Started
              </Link>
            </div>
          ...
          <button
            type="button"
            className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-border bg-surface text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 md:hidden"
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div
              className="border-t border-border bg-card px-4 pb-6 pt-4 backdrop-blur-xl"
              role="navigation"
